...
firebase.initializeApp(config);
      ...
      dbSBRef.on('value', snap => {
        ...
        for (var index in scores) {
          HTMLReplacement += '<div class="scoreentry"><span class="name">' + scores[index].key + 
            '</span><span class="score">' + scores[index].val + ' points</span></div>'
        }
      ...
      dbCPRef.on('value', snap => {
        ...
        if (curPlayer !== null) {
          ...
          if (key !== "dummy") {
            HTMLReplacementCS = '<div id="playing"><div id="current_player_score"><span id="current_score">'+curPlayer[key]+'</span><span class="poengtext">points</span></div><div id="current_player"><span id="playingtext"> Playing<br><span id="current_player_name">' +key+'</span> </span>  </div><div id="current_player_dots"><div id="wave">'
            +'<span class="dot"></span>'
            +'<span class="dot"></span>'
